...
/**
 * This process class that indicates the structure of the process and its attributes,
 * it will be used in all the scheduling algorithms to create the processes and manipulate them.
 *
 * <p>
 * The attributes of the process include:
 * Stores the process identity, priority, timing values, and runtime
 * metrics such as waiting time, turnaround time, completion time, and
 * response time.
 * </p>
 *
